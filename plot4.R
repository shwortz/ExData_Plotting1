...
plot(d$Time, d[,3], type = "n", xlab = "", ylab = "Global Active Power (kilowatts)")
lines(d$Time, d[,3])
...
plot(d$Time, d$Voltage, xlab = "datetime", ylab = "Voltage", type = "n")
lines(d$Time, d$Voltage)
 
plot(d$Time, d[,4], xlab = "datetime", ylab = "Global_reactive_power", type = "n")
lines(d$Time, d[,4])
dev.off()